...
public class PeriodicalXmlValidator extends DefaultHandler {
    public static final String SCHEMA_FILE_NAME = "periodicals.xsd";

    private StringBuilder error = new StringBuilder();

    private String fileName;

    public PeriodicalXmlValidator(String fileName) {
